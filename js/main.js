$(document).ready(function(){
    ...
    const side_bar = {"QUALIFICATIONS": ["Full Stack Web Developer", "Wix Velo certified Developer", "BEng Tech Electrical Engineering", "Electrician"], "SKILLS": ["HTML, CSS, JS","dc & Crossfilter", "Bootstrap", "Python", "Django", "Flask", "SQL", "Database design and management", "Git", "Heroku", "Stripe", "AWS", "e-Commerce", "gSheets", "Fault finding / troubleshooting"], "PROJECTS": ["World Cup Wizard", "EPOS"], "REFERENCES": ["Padraig Cahill - Opus Web Design", "087 966 3260", "Cathal Dolan - gizagig", "086 679 4786"]}
